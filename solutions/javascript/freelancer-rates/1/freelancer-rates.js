...
export function priceWithMonthlyDiscount(ratePerHour, numDays, discount) {
  ...
  const dailyRate = ratePerHour * HOURS_PER_DAY;
  const monthlyRate = dailyRate * BILLABLE_DAYS_PER_MONTH;
  ...
  const total = fullMonths * discountedMonthlyRate + remainingDays * dailyRate;
